...
const Navbar = () => {
  ...
  return (
   <nav className={`fixed top-0 w-full z-50 transition durartion-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${
      isScrolled ? "bg-bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"
   }`}>
    <div className='text-white py-5 flex justify-between items-center'>
      {/*Logo*/}
      <div className='text-white py-5 flex justify-between items-center'>
      <span className='text-[#8245ec]'>&lt;</span>
      <span className='text-white'>Shadab</span>
      <span className='text-[#8245ec]'>/</span>
  ...
  activeSection === item.id ? "text-[#8245ec]" : ""
      ...
      <div className='hidden md:flex space-x-4'>
           <a href='https://github.com/Shadabmkhann'
           target='_blank' 
        ...
        >
            ...
            <a href='http://www.linkedin.com/in/shadab-khan-6b429518b'
           target='_blank' 
           rel='noopener noreferrer'
           className='text-gray-300 hover:text-[#8245ec]'
        >
